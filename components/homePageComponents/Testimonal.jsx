    ...
    <div className={styles.container}>
      ...
      <div className={styles.cardContainer}>
        <div className={styles.card}>
          <Image src="/img/avatar1.png" width="64" height="64" className={styles.image}></Image>
        ...
        <div className={styles.card}>
          <Image src="/img/avatar2.png" width="64" height="64" className={styles.image}></Image>
          <div className={styles.text}>
        ...
        <div className={styles.card}>
          <Image src="/img/avatar3.png" width="64" height="64" className={styles.image}></Image>
          <div className={styles.text}>
