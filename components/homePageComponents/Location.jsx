    ...
    <div className={styles.container}>
      <div className={styles.left}>
        ...
        <div className={styles.item}>
          <Image width="382" height="510" src="/img/bar.jpg" className={styles.image}></Image>
      ...
      <div className={styles.right}>
        <div className={styles.item}>
          <Image width="520" height="350" src="/img/exterior.jpg" className={styles.image}></Image>
          <div className={styles.text}>
            <b>Inviting Front</b>
        ...
        <div className={styles.item}>
          <Image width="520" height="350" src="/img/host.jpg" className={styles.image}></Image>
          <div className={styles.text}>
            <b>Cozy Place</b>
